...
import './Mission.css';
import founders1 from '../../Images/people/p1.jpg';
  ...
  return (
    ...
    <div className="about-container">
      <div className="header">
        <h1>Our Mission at Gifts of Hope</h1>
      </div>
      <div className="intro">
        <p>
      ...
      <div className="mission">
        ...
        {<img src={founders1} alt="Classroom 1" style={imageStyle}/>}
      </div>
      ...
      <div className="mission">
        ...
        {<img src={founders3} alt="Classroom 1" style={imageStyle}/>}
      </div>
